...
import { CERVIDAE_THEME } from "./colors";
import cervidaeData from "./data/cervidae.json";
...
const fullData = cervidaeData as TaxonNode;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
          <span style={{ fontSize: 18, fontWeight: 600, letterSpacing: "-0.01em" }}>Cervidae</span>
