...
const PARTS: {
  ...
  },
  {
    ...
    title: "Part II — Aves",
    chapters: [
      { orderFile: "PASSERIFORMES", orderName: "Passeriformes", title: "Chapter 1 — Passeriformes", familySlugs: ["corvidae", "fringillidae", "paradisaeidae"] },
      ...
      { orderFile: "PROCELLARIIFORMES", orderName: "Procellariiformes", title: "Chapter 6 — Procellariiformes", familySlugs: ["diomedeidae"] },
      { orderFile: "SULIFORMES", orderName: "Suliformes", title: "Chapter 7 — Suliformes", familySlugs: ["fregatidae"] },
      ...
      { orderFile: "ACCIPITRIFORMES", orderName: "Accipitriformes", title: "Chapter 9 — Accipitriformes", familySlugs: ["accipitridae", "cathartidae"] },
      ...
      { orderFile: "GRUIFORMES", orderName: "Gruiformes", title: "Chapter 12 — Gruiformes", familySlugs: ["gruidae", "otididae"] },
      { orderFile: "CHARADRIIFORMES", orderName: "Charadriiformes", title: "Chapter 13 — Charadriiformes", familySlugs: ["laridae", "stercorariidae"] },
      ...
      { orderFile: "ANSERIFORMES", orderName: "Anseriformes", title: "Chapter 16 — Anseriformes", familySlugs: ["anatidae"] },
      { orderFile: "GALLIFORMES", orderName: "Galliformes", title: "Chapter 17 — Galliformes", familySlugs: ["phasianidae", "cracidae"] },
      { orderFile: "CORACIIFORMES", orderName: "Coraciiformes", title: "Chapter 18 — Coraciiformes", familySlugs: ["alcedinidae"] },
      ...
      { orderFile: "APODIFORMES", orderName: "Apodiformes", title: "Chapter 21 — Apodiformes", familySlugs: ["trochilidae"] },
      { orderFile: "PICIFORMES", orderName: "Piciformes", title: "Chapter 22 — Piciformes", familySlugs: ["picidae", "ramphastidae"] },
    ],
  },
  {
