...
import { GIRAFFIDAE_THEME } from "./colors";
import giraffidaeData from "./data/giraffidae.json";
...
const fullData = giraffidaeData as TaxonNode;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
          <span style={{ fontSize: 18, fontWeight: 600, letterSpacing: "-0.01em" }}>Giraffidae</span>
