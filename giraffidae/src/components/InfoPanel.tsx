...
import { LINEAGE_COLORS } from "../colors";
  ...
  return (
    <div style={{ padding: "24px 20px", color: "#888", fontSize: 13, lineHeight: 1.6 }}>
      ...
      <div style={{ marginTop: 20, padding: "12px 14px", borderRadius: 8, background: "#111", fontSize: 12, lineHeight: 1.7 }}>
        ...
        <div style={{ color: "#666" }}>
          Giraffidae contains only two living genera: <em style={{ color: "#888" }}>Giraffa</em> (giraffes, the world's
          tallest animals) and <em style={{ color: "#888" }}>Okapia</em> (the okapi). Despite its zebra-striped legs,
          the okapi is the giraffe's closest relative — not known to Western science until 1901, when it was
          found deep in the Congo rainforest. All four giraffe species are endemic to sub-Saharan Africa.
        </div>
      </div>
